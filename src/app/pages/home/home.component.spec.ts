...
describe('HomeComponent', () => {
  ...
  describe('pull-to-refresh, logout, and memorization handlers', () => {
    ...
    it('addRecommendedVerse calls addVerse and toasts success', async () => {
      const m = makeMocks();
