      ...
      >
        ...
        >
          ...
          <div class="flex items-center gap-2">
            <span class="w-10 text-center" title="Email notifications"
              >Email</span
            >
            <span class="w-10 text-center" title="Push notifications"
              >Push</span
            >
        ...
        >
          <p class="text-xs text-blue-800 dark:text-blue-200">
            <strong>Note:</strong> Admin users can sign in using magic links
            sent to their email. When you add a new admin, they'll receive an
