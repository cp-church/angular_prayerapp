...
- **Node**: Angular 22 requires **Node ≥ 22.22.3** (or 24.15+). [`package.json`](../package.json) **`engines.node`** is **`22.x`** for Vercel (major-only; avoids `>=` auto-major warnings). CI [`.github/workflows/test.yml`](.github/workflows/test.yml) and [`.nvmrc`](../.nvmrc) pin **`22.22.3`** for local/CI. See [docs/SETUP.md](docs/SETUP.md).
